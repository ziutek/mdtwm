...
func putKeyPressEvent(e KeyPressEvent, b []byte) {
	b[1] = e.Detail
	put32(b[4:], uint32(e.Time))
	put32(b[8:], uint32(e.Root))
	put32(b[12:], uint32(e.Event))
	put32(b[16:], uint32(e.Child))
	put16(b[20:], uint16(e.RootX))
	put16(b[22:], uint16(e.RootY))
	put16(b[24:], uint16(e.EventX))
	put16(b[26:], uint16(e.EventY))
	put16(b[28:], e.State)
	if e.SameScreen {
		b[30] = 1
	} else {
...
func putKeyReleaseEvent(e KeyReleaseEvent, b []byte) {
	putKeyPressEvent((KeyPressEvent)(e), b)
}
...
func putButtonPressEvent(e ButtonPressEvent, b []byte) {
	b[1] = e.Detail
	put32(b[4:], uint32(e.Time))
	put32(b[8:], uint32(e.Root))
	put32(b[12:], uint32(e.Event))
...
func putButtonReleaseEvent(e ButtonReleaseEvent, b []byte) {
	putButtonPressEvent((ButtonPressEvent)(e), b)
}
...
func putMotionNotifyEvent(e MotionNotifyEvent, b []byte) {
	b[1] = e.Detail
	put32(b[4:], uint32(e.Time))
	put32(b[8:], uint32(e.Root))
	put32(b[12:], uint32(e.Event))
...
func putEnterNotifyEvent(e EnterNotifyEvent, b []byte) {
	b[1] = e.Detail
	put32(b[4:], uint32(e.Time))
	put32(b[8:], uint32(e.Root))
	put32(b[12:], uint32(e.Event))
...
func putLeaveNotifyEvent(e LeaveNotifyEvent, b []byte) {
	putEnterNotifyEvent((EnterNotifyEvent)(e), b)
}
...
func putFocusInEvent(e FocusInEvent, b []byte) {
	b[1] = e.Detail
	put32(b[4:], uint32(e.Event))
	b[8] = e.Mode
}
...
func putFocusOutEvent(e FocusOutEvent, b []byte) {
	putFocusInEvent((FocusInEvent)(e), b)
}
...
func putKeymapNotifyEvent(e KeymapNotifyEvent, b []byte) {
	copy(b[1:32], e.Keys[:])
}
...
func putExposeEvent(e ExposeEvent, b []byte) {
	put32(b[4:], uint32(e.Window))
	put16(b[8:], e.X)
	put16(b[10:], e.Y)
	put16(b[12:], e.Width)
	put16(b[14:], e.Height)
...
func putGraphicsExposureEvent(e GraphicsExposureEvent, b []byte) {
	put32(b[4:], uint32(e.Drawable))
	put16(b[8:], e.X)
	put16(b[10:], e.Y)
	put16(b[12:], e.Width)
	put16(b[14:], e.Height)
	put16(b[16:], e.MinorOpcode)
	put16(b[18:], e.Count)
	b[20] = e.MajorOpcode
}
...
func putNoExposureEvent(e NoExposureEvent, b []byte) {
	put32(b[4:], uint32(e.Drawable))
	put16(b[8:], e.MinorOpcode)
	b[10] = e.MajorOpcode
}
...
func putVisibilityNotifyEvent(e VisibilityNotifyEvent, b []byte) {
	put32(b[4:], uint32(e.Window))
	b[8] = e.State
}
...
func putCreateNotifyEvent(e CreateNotifyEvent, b []byte) {
	put32(b[4:], uint32(e.Parent))
	put32(b[8:], uint32(e.Window))
	put16(b[12:], uint16(e.X))
	put16(b[14:], uint16(e.Y))
	put16(b[16:], e.Width)
	put16(b[18:], e.Height)
	put16(b[20:], e.BorderWidth)
...
func putDestroyNotifyEvent(e DestroyNotifyEvent, b []byte) {
	put32(b[4:], uint32(e.Event))
	put32(b[8:], uint32(e.Window))
}
...
func putUnmapNotifyEvent(e UnmapNotifyEvent, b []byte) {
	put32(b[4:], uint32(e.Event))
	put32(b[8:], uint32(e.Window))
	if e.FromConfigure {
		b[12] = 1
...
func putMapNotifyEvent(e MapNotifyEvent, b []byte) {
	put32(b[4:], uint32(e.Event))
	put32(b[8:], uint32(e.Window))
	if e.OverrideRedirect {
		b[12] = 1
...
func putMapRequestEvent(e MapRequestEvent, b []byte) {
	put32(b[4:], uint32(e.Parent))
	put32(b[8:], uint32(e.Window))
}
...
func putReparentNotifyEvent(e ReparentNotifyEvent, b []byte) {
	put32(b[4:], uint32(e.Event))
	put32(b[8:], uint32(e.Window))
	put32(b[12:], uint32(e.Parent))
	put16(b[16:], uint16(e.X))
	put16(b[18:], uint16(e.Y))
	if e.OverrideRedirect {
		b[20] = 1
	} else {
		b[20] = 0
...
func putConfigureNotifyEvent(e ConfigureNotifyEvent, b []byte) {
	put32(b[4:], uint32(e.Event))
	put32(b[8:], uint32(e.Window))
	put32(b[12:], uint32(e.AboveSibling))
	put16(b[16:], uint16(e.X))
	put16(b[18:], uint16(e.Y))
	put16(b[20:], e.Width)
	put16(b[22:], e.Height)
	put16(b[24:], e.BorderWidth)
	if e.OverrideRedirect {
		b[26] = 1
	} else {
		b[26] = 0
...
func putConfigureRequestEvent(e ConfigureRequestEvent, b []byte) {
	b[1] = e.StackMode
	put32(b[4:], uint32(e.Parent))
	put32(b[8:], uint32(e.Window))
	put32(b[12:], uint32(e.Sibling))
	put16(b[16:], uint16(e.X))
	put16(b[18:], uint16(e.Y))
	put16(b[20:], e.Width)
	put16(b[22:], e.Height)
	put16(b[24:], e.BorderWidth)
	put16(b[26:], e.ValueMask)
}
...
func putGravityNotifyEvent(e GravityNotifyEvent, b []byte) {
	put32(b[4:], uint32(e.Event))
	put32(b[8:], uint32(e.Window))
	put16(b[12:], uint16(e.X))
	put16(b[14:], uint16(e.Y))
...
func putResizeRequestEvent(e ResizeRequestEvent, b []byte) {
	put32(b[4:], uint32(e.Window))
	put16(b[8:], e.Width)
	put16(b[10:], e.Height)
}
...
func putCirculateNotifyEvent(e CirculateNotifyEvent, b []byte) {
	put32(b[4:], uint32(e.Event))
	put32(b[8:], uint32(e.Window))
	b[16] = e.Place
}
...
func putCirculateRequestEvent(e CirculateRequestEvent, b []byte) {
	putCirculateNotifyEvent((CirculateNotifyEvent)(e), b)
}
...
func putPropertyNotifyEvent(e PropertyNotifyEvent, b []byte) {
	put32(b[4:], uint32(e.Window))
	put32(b[8:], uint32(e.Atom))
	put32(b[12:], uint32(e.Time))
	b[16] = e.State
}
...
func putSelectionClearEvent(e SelectionClearEvent, b []byte) {
	put32(b[4:], uint32(e.Time))
	put32(b[8:], uint32(e.Owner))
	put32(b[12:], uint32(e.Selection))
}
...
func putSelectionRequestEvent(e SelectionRequestEvent, b []byte) {
	put32(b[4:], uint32(e.Time))
	put32(b[8:], uint32(e.Owner))
	put32(b[12:], uint32(e.Requestor))
	put32(b[16:], uint32(e.Selection))
	put32(b[20:], uint32(e.Target))
	put32(b[24:], uint32(e.Property))
}
...
func putSelectionNotifyEvent(e SelectionNotifyEvent, b []byte) {
	put32(b[4:], uint32(e.Time))
	put32(b[8:], uint32(e.Requestor))
	put32(b[12:], uint32(e.Selection))
	put32(b[16:], uint32(e.Target))
	put32(b[20:], uint32(e.Property))
}
...
func putColormapNotifyEvent(e ColormapNotifyEvent, b []byte) {
	put32(b[4:], uint32(e.Window))
	put32(b[8:], uint32(e.Colormap))
	if e.New {
		b[12] = 1
	} else {
		b[12] = 0
...
func putClientMessageEvent(e ClientMessageEvent, b []byte) {
	b[1] = e.Format
	put32(b[4:], uint32(e.Window))
	put32(b[8:], uint32(e.Type))
	putClientMessageData(b[12:], &e.Data)
}
...
func putMappingNotifyEvent(e MappingNotifyEvent, b []byte) {
	b[4] = e.Request
	b[5] = e.FirstKeycode
	b[6] = e.Count
}
...
func putEvent(event Event, buf []byte) error {
	...
	case KeyPressEvent:
		buf[0] = KeyPress
		putKeyPressEvent(e, buf)
	case KeyReleaseEvent:
		buf[0] = KeyRelease
		putKeyReleaseEvent(e, buf)
	case ButtonPressEvent:
		buf[0] = ButtonPress
		putButtonPressEvent(e, buf)
	case ButtonReleaseEvent:
		buf[0] = ButtonRelease
		putButtonReleaseEvent(e, buf)
	case MotionNotifyEvent:
		buf[0] = MotionNotify
		putMotionNotifyEvent(e, buf)
	case EnterNotifyEvent:
		buf[0] = EnterNotify
		putEnterNotifyEvent(e, buf)
	case LeaveNotifyEvent:
		buf[0] = LeaveNotify
		putLeaveNotifyEvent(e, buf)
	case FocusInEvent:
		buf[0] = FocusIn
		putFocusInEvent(e, buf)
	case FocusOutEvent:
		buf[0] = FocusOut
		putFocusOutEvent(e, buf)
	case KeymapNotifyEvent:
		buf[0] = KeymapNotify
		putKeymapNotifyEvent(e, buf)
	case ExposeEvent:
		buf[0] = Expose
		putExposeEvent(e, buf)
	case GraphicsExposureEvent:
		buf[0] = GraphicsExposure
		putGraphicsExposureEvent(e, buf)
	case NoExposureEvent:
		buf[0] = NoExposure
		putNoExposureEvent(e, buf)
	case VisibilityNotifyEvent:
		buf[0] = VisibilityNotify
		putVisibilityNotifyEvent(e, buf)
	case CreateNotifyEvent:
		buf[0] = CreateNotify
		putCreateNotifyEvent(e, buf)
	case DestroyNotifyEvent:
		buf[0] = DestroyNotify
		putDestroyNotifyEvent(e, buf)
	case UnmapNotifyEvent:
		buf[0] = UnmapNotify
		putUnmapNotifyEvent(e, buf)
	case MapNotifyEvent:
		buf[0] = MapNotify
		putMapNotifyEvent(e, buf)
	case MapRequestEvent:
		buf[0] = MapRequest
		putMapRequestEvent(e, buf)
	case ReparentNotifyEvent:
		buf[0] = ReparentNotify
		putReparentNotifyEvent(e, buf)
	case ConfigureNotifyEvent:
		buf[0] = ConfigureNotify
		putConfigureNotifyEvent(e, buf)
	case ConfigureRequestEvent:
		buf[0] = ConfigureRequest
		putConfigureRequestEvent(e, buf)
	case GravityNotifyEvent:
		buf[0] = GravityNotify
		putGravityNotifyEvent(e, buf)
	case ResizeRequestEvent:
		buf[0] = ResizeRequest
		putResizeRequestEvent(e, buf)
	case CirculateNotifyEvent:
		buf[0] = CirculateNotify
		putCirculateNotifyEvent(e, buf)
	case CirculateRequestEvent:
		buf[0] = CirculateRequest
		putCirculateRequestEvent(e, buf)
	case PropertyNotifyEvent:
		buf[0] = PropertyNotify
		putPropertyNotifyEvent(e, buf)
	case SelectionClearEvent:
		buf[0] = SelectionClear
		putSelectionClearEvent(e, buf)
	case SelectionRequestEvent:
		buf[0] = SelectionRequest
		putSelectionRequestEvent(e, buf)
	case SelectionNotifyEvent:
		buf[0] = SelectionNotify
		putSelectionNotifyEvent(e, buf)
	case ColormapNotifyEvent:
		buf[0] = ColormapNotify
		putColormapNotifyEvent(e, buf)
	case ClientMessageEvent:
		buf[0] = ClientMessage
		putClientMessageEvent(e, buf)
